...
/// 1xx Informational
public enum InformationalStatus: Int, Error {
...
/// 2xx Success
public enum SuccessStatus: Int, Error {
    case ok = 200
    case created = 201
    case accepted = 202
...
/// 3xx Redirection
public enum RedirectionStatus: Int, Error {
...
/// 4xx Client Error
public enum ClientErrorStatus: Int, Error {
    case badRequest = 400
...
/// Internal Status
public enum InternalStatus: Int, Error {
    case internetAccessError = 1
    case unknown = 2
    case invalidUrl = 3
    case noData = 4
    case decodingFailed = 5
    case noPermission = 6
